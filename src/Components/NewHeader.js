...
import LogoIcon from "../Assets/Logo/output-onlinepngtools.png";
            ...
            <div class="flex items-center justify-between h-16">
                <div class=" flex items-center">
                    <a class="flex-shrink-0" href="/">
                        <img class="w-12 h-12" src={LogoIcon} alt="Workflow"/>
                    </a>
                    ...
                    <div class="flex items-center ml-4 md:ml-6">
                        <div class="relative ml-3">
                            <div class="relative inline-block text-left">
                                ...
                                <div class="absolute right-0 w-56 mt-2 hidden origin-top-right bg-white rounded-md shadow-lg dark:bg-gray-800 ring-1 ring-black ring-opacity-5">
